...
public class SecurityConfig {
    ...
    private final JwtAuthenticationFilter jwtAuthenticationFilter; // ✅ otomatik inject
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/ticket-clerks").permitAll()
                ...
                .addFilterBefore(jwtAuthenticationFilter, UsernamePasswordAuthenticationFilter.class); // ✅ spring-managed bean
