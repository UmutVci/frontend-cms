...
export default function Header() {
    return(
        <div className="flex items-center justify-between h-20 bg-white px-6 shadow-md font-bold font-[Poppins]">
            {/* Sol başlık */}
            <h1 className="text-2xl font-normal text-black ml-4">Overview</h1>
